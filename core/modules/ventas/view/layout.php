    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" >Shop Mary <span class="label label-danger">50%</span></small></a>
        </div>
...
?>
          ...
          <li><a href="index.php?view=products"><i class="fa fa-glass"></i> Productos <small><span class="label label-success">Nuevo</span></small> </a></li>
